...
TASK_TYPE_DESCRIPTIONS: dict[TaskType, str] = {
    ...
    TaskType.ERROR_CORRECTION: "Correct an error in the ledger (reverse or adjust a voucher). Also covers cost analysis / ledger discrepancy investigation.",
    TaskType.YEAR_END_CLOSING: "Perform year-end closing procedures: annual depreciation, close revenue/expense accounts to retained earnings (årsavslutning/årsoppgjør/årsoppgjer/encerramento anual/Jahresabschluss)",
    TaskType.MONTH_END_CLOSING: "Perform month-end closing: create accrual/periodification vouchers and monthly depreciation entries (månedsslutt/månavslutninga/cierre mensual/fechamento mensal/Monatsabschluss)",
