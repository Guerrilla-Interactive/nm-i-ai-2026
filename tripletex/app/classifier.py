...
def _last_resort_classify(prompt: str) -> TaskClassification:
    ...
    _LAST_RESORT = [
        ...
        (["lønn", "lonn", "payroll", "paie", "gehalt", "nómina", "salaire", "lønnskjøring", "lonnskjoring", "lønnsslipp", "salary"], TaskType.RUN_PAYROLL),
        (["leverandørfaktura", "leverandorfaktura", "inngående faktura", "eingangsrechnung", "supplier invoice", "vendor invoice", "lieferantenrechnung", "facture fournisseur"], TaskType.REGISTER_SUPPLIER_INVOICE),
        ...
        (["årsavslut", "arsavslut", "årsoppgjør", "year-end", "year end", "jahresabschluss", "clôture", "avslutt år"], TaskType.YEAR_END_CLOSING),
