...
_KEYWORD_MAP = [
    ...
    (TaskType.ERROR_CORRECTION, [r"\b(korriger|korrigér|correct|fiks|fix)\w*\b.*\b(feil|error|bilag|voucher|postering)\b",
                                   r"\b(feil|error)\w*\b.*\b(korriger|korrigér|correct|rett)\b",
    ...
    (TaskType.REGISTER_SUPPLIER_INVOICE, [
        ...
        r"\b(registrer|bokfør|bokfor|book)\w*\b.*\b(inngående|inngaaende|inngaende|incoming|mottatt)\w*\b.*\bfaktura\w*\b",
        r"(inngående|inngaaende|inngaende|incoming|mottatt|motteke|received).*faktura",
        ...
        # "faktura fra <Name>" = invoice FROM someone = supplier invoice
        r"\bfaktura\s+fra\s+[A-ZÆØÅ]",
        ...
        # Portuguese: "fatura do/de fornecedor" / "despesa...recibo" (expense receipt)
        r"\bfatura\b.*\b(do|de)\s+fornecedor\b",
        r"\bdespesa\b.*\brecibo\b",
        r"\brecibo\b.*\bdespesa\b",
    ...
    (TaskType.DELETE_PROJECT, [r"\b(slett|delete|remove|löschen|lösche|eliminar|supprimer)\b.*\bprosjekt\w*\b",
                                r"\b(slett|delete|remove|löschen|lösche|eliminar|supprimer)\b.*\b(project|proyecto|projekt|projet)\b"]),
